    ...
    <Stack spacing={4} onClick={children && onToggle}>
      ...
      <Collapse in={isOpen} animateOpacity style={{ marginTop: "0!important" }}>
        ...
        >
          {children &&
            children.map((child) => (
              <Link key={child.label} py={2} href={`product/${child.href}`}>
                {child.label}
              </Link>
            ))}
        </Stack>
  ...
  },
  {
    ...
    col3: [
...

      {
        ...
        subLabel: [
          "Action-Figurine & Collectibles",
          "Creative & Educational Toys",
          "Gaming",
          "Robots & Vehicles",
          "Infants Toys",
          "Role & Pretend PlaySchool",
          "Party Supplies & BooksSoft",
          "ToysToy-Guns & Accessories",
        ],
        href: "kids",
      },
    ],
